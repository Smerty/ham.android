...
public class ham extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// table.addView(this.getTableRow("PSKreporter", "current solar conditions", PSKReporter.class, R.drawable.radar_icon, null, this));
		...
		// table.addView(this.getTableRow("Credits", "current solar conditions", null, R.drawable.gear_icon, "http://smerty.org", this));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case MENU_ABOUT:
			Toast.makeText(getBaseContext(), "Developed by Smerty Software (Paul K6SH)", Toast.LENGTH_LONG).show();
			return true;
		case MENU_REFRESH:
			this.onCreate(null);
			return true;
